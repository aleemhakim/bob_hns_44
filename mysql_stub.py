...
#  mycursor.execute("CREATE TABLE Domains(Name VARCHAR(255),Status VARCHAR(255))")
  mycursor.execute("Create Table Domains(Name VARCHAR(255),WalletID VARCHAR(255),Decoded_Punycode VARCHAR(255),Status VARCHAR(255),Reserved VARCHAR(255),HoursUntilBidding VARCHAR(255),HoursUntilReveal VARCHAR(255),HoursUntilClose VARCHAR(255),DaysUntilExpire VARCHAR(255))")


u = input("check record")
